...
public class RegisterActivity extends Activity {
     ...
     * */
    private void registerUser(final String name, final String email, final String password,final String number) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(RegisterActivity.this,Universities.class);
                        startActivity(intent);
                        finish();
                    } else {
