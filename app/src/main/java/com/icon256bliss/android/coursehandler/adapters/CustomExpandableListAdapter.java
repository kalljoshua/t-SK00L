...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<PossibleChoice>> expandableListDetail;
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final PossibleChoice expandedListText = (PossibleChoice) getChild(listPosition, expandedListPosition);
        if (convertView == null) {
        ...
        expandedListTextView.setText(expandedListText.courseName);
        return convertView;
    }
